...
const TodoListComponent = () => {
    ...
    const getTodos = async () => {
        try {
            ...
            const response = await fetch("https://todo-list-789.herokuapp.com/all");
    ...
    const updateTodo = async (todo, is_deleted) => {
        try {
            ...
            // console.log(body);
            const response = await fetch("https://todo-list-789.herokuapp.com/update?id=" + todo.id, {
                method: "POST",
    ...
    const onAdd = async e => {
        try {
            ...
            console.log(body);
            console.log("ddbncd");
            const response = await fetch("https://todo-list-789.herokuapp.com/create", {
                method: "POST",
                headers: { "Content-Type": "application/json" },
                body: JSON.stringify(body)
